...
var named = "Jason Davis"; //grab name from local storage
var ID = "f005g23"; //grab ID from local storage
...
const result = new Result(named, ID, data, stimulus_info.getSeedArray()); //create new Result object
results_set.push(result); //add new object to stored offline array