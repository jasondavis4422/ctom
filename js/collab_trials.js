...
{
 if (localStorage.getItem('trial_number') == null) {
    localStorage.setItem('trial_number', '0')
    trial_number = 0;
 }
 trial_number = parseInt(localStorage.getItem('trial_number'));
 trial_number++;
 localStorage.setItem('trial_number', trial_number.toString());
}
  ...
  next_button.addEventListener('click', function (event) {
    ...
    save_rating_data();
    save_stimulus_data();
    var trial = parseInt(localStorage.getItem('trial_number'));
